...
//    a.setWindowIcon(QIcon(":/main.ico"));
	...
	App::Protocollst << IEC_104 << IEC_101 << IEC_103WISCOMNET << IEC_103COM << IEC_103ASDU;
    ...
    frmMain w;
	w.setWindowTitle(QString("网络串口调试助手V1.12测试版   ") + QString("本机IP: %1 ").arg(QUIHelper::getLocalIP()) + QString("          作者：王洪星"));
    w.show();
